...
describe('AddEditCatalogItemModal', () => {
  ...
  const mockEvents: EventData[] = [
    { id: 'event-1', name: 'Summer Seminar', slug: 'summer-seminar', description: null, eventType: 'seminar', location: null, note: null, imageUrl: null, registrationDeadline: null, isPublic: true, maxCapacity: 50, isActive: true, tags: [], sessions: [], billing: [] },
    { id: 'event-2', name: 'Winter Camp', slug: 'winter-camp', description: null, eventType: 'camp', location: null, note: null, imageUrl: null, registrationDeadline: null, isPublic: true, maxCapacity: 30, isActive: true, tags: [], sessions: [], billing: [] },
    { id: 'event-3', name: 'Inactive Event', slug: 'inactive-event', description: null, eventType: 'workshop', location: null, note: null, imageUrl: null, registrationDeadline: null, isPublic: true, maxCapacity: 20, isActive: false, tags: [], sessions: [], billing: [] },
  ];
